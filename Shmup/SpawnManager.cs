...
public class SpawnManager : MonoBehaviour
{
    ...
    IEnumerator SpawnWaves()
    {
        ...
        //Instantiate(Wave1Enemies, new Vector3(25, 11, 19), Quaternion.identity); //Quaternion.identity = rotatie 0,0,0
        Instantiate(Wave1Enemies, new Vector3(25, 6, 19), Quaternion.identity); //Quaternion.identity = rotatie 0,0,0
